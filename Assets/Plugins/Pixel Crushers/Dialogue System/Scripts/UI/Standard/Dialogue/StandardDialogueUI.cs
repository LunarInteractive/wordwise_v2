...
namespace PixelCrushers.DialogueSystem
{
    ...
    {
        public UnityEvent<Subtitle, Response[], float> showResponseOptionsEvent = new UnityEvent<Subtitle, Response[], float>();
        ...
        public override void ShowResponses(Subtitle subtitle, Response[] responses, float timeout)
        {
            ...
            showResponseOptionsEvent.Invoke(subtitle, responses, timeout);
        }
